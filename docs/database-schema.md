...
**Table Name**: `InavoreShuttle-{environment}-shops`
...
**Table Name**: `InavoreShuttle-{environment}-jobs`
...
const job = await dynamodb.getItem({
  TableName: 'InavoreShuttle-dev-jobs',
...
**Table Name**: `InavoreShuttle-{environment}-import-history`
...
const history = await dynamodb.query({
  TableName: 'InavoreShuttle-dev-import-history',
...
- [ ] Deploy stack: `cdk deploy InavoreShuttle-dev`
- [ ] Verify table creation: `aws dynamodb describe-table --table-name InavoreShuttle-dev-shops`
- [ ] Insert test data: `aws dynamodb put-item --table-name InavoreShuttle-dev-shops --item ...`
- [ ] Query by primary key: `aws dynamodb get-item --table-name InavoreShuttle-dev-jobs --key ...`
- [ ] Query GSI: `aws dynamodb query --table-name InavoreShuttle-dev-jobs --index-name shopDomain-createdAt-index ...`
...
# InavoreShuttle-dev.ShopsTableArn = arn:aws:dynamodb:us-east-1:123456789:table/InavoreShuttle-dev-shops
# InavoreShuttle-dev.JobsTableName = InavoreShuttle-dev-jobs
# InavoreShuttle-dev.JobsTableArn = arn:aws:dynamodb:us-east-1:123456789:table/InavoreShuttle-dev-jobs
# InavoreShuttle-dev.ImportHistoryTableName = InavoreShuttle-dev-import-history
# InavoreShuttle-dev.ImportHistoryTableArn = arn:aws:dynamodb:us-east-1:123456789:table/InavoreShuttle-dev-import-history
```
